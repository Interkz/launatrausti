...
| Source | Has API | Company-Specific | Has Wage Data | Cost |
|--------|---------|------------------|---------------|------|
...
The Skatturinn API only provides company metadata. To get actual wage data:

**Option A: PDF Extraction (Free)**
...
**Option B: Creditinfo API (Paid)**
- Has structured annual account data
- Contact: https://developer.creditinfo.is/

### 2. Add Hagstofa Integration
